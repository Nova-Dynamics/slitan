(() => {
  ...
  // ../../lib/shims/socket.io-client.js
  var require_socket_io_client = __commonJS({
    "../../lib/shims/socket.io-client.js"(exports, module) {
  ...
  // ../../lib/shims/entangld.js
  var require_entangld = __commonJS({
    "../../lib/shims/entangld.js"(exports, module) {
      init_define_process_env();
      var Datastore = class {
        attach() {
        }
  ...
  var require_Page = __commonJS({
    "../../lib/Page.js"(exports, module) {
      init_define_process_env();
      var IO = require_socket_io_client();
      var Datastore = require_entangld();
      var { EventEmitter } = require_events();
      var Page = class extends EventEmitter {
        static page_name = "";
        get page_name() {
          return this.constructor.page_name;
        }
        constructor(app, container_selector, { io, use_entangld = false, allow_null_loads = false } = {}) {
          ...
          if (this.on_correct_page(allow_null_loads))
            this.start();
        }
        /**
        ...
        on_correct_page(allow_null = false) {
          if (allow_null && this.app.current_page == void 0) {
            return true;
          }
  ...
  // ../../lib/PartialsRenderer.js
  var require_PartialsRenderer = __commonJS({
    "../../lib/PartialsRenderer.js"(exports, module) {
      init_define_process_env();
      var Mustache = require_mustache();
      var PartialsRenderer = class {
  ...
  var require_Partial = __commonJS({
    "../../lib/Partial.js"(exports, module) {
      init_define_process_env();
      var PartialsRenderer = require_PartialsRenderer();
      var Datastore = require_entangld();
      var { EventEmitter } = require_events();
      var Partial = class extends EventEmitter {
        static template = "";
         ...
         * @constructor
         */
        constructor(page, parent = null, opts = {
          /* use me in sub-classes */
        }) {
          super();
          this.page = page;
          this.parent = parent;
         ...
         * @param {string} [selector=null] - The selector to use render the child into (if none, will be rendered into the top level)
         */
        create_child(Partial2, selector = null, opts = {}) {
          const partial = new Partial2(this.page, this, opts);
  ...
  var require_empty = __commonJS({
    "../../lib/shims/empty.js"(exports, module) {
      init_define_process_env();
      module.exports = {};
    }
  });
  ...
  var require_EntryPoint = __commonJS({
    "../../lib/EntryPoint.js"(exports, module) {
      init_define_process_env();
      var { EventEmitter } = require_events();
      var Datastore = require_entangld();
      var Cookies = require_socket_io_client();
      window.$ = require_jquery();
      window.jQuery = window.$;
      var EntryPoint2 = class extends EventEmitter {
        /**
         * Constructor
         */
        constructor() {
          super();
          this.Cookies = require_empty();
          this.request = require_empty();
          this.HashObject = require_empty();
          this.datastore = new Datastore();
          this.datastore.set("", {
            pages: {}
          });
        ...
        async load_page(page_name, force_refresh = false) {
          if (page_name == this.current_page && !force_refresh)
            return;
          const page = this.get_page(page_name);
          if (!page)
            throw new Error("Unknown page name: " + page_name);
          const urlParams = new URLSearchParams(window.location.search);
          urlParams.set("page", page_name);
          window.location.search = urlParams;
        }
      };
      module.exports = EntryPoint2;
    }
  });

  // ../../index.js
  var require_slitan = __commonJS({
    "../../index.js"(exports, module) {
      init_define_process_env();
      var Page = require_Page();
      var Partial = require_Partial();
      var PartialsRenderer = require_PartialsRenderer();
      var EntryPoint2 = require_EntryPoint();
      module.exports = { Page, Partial, PartialsRenderer, EntryPoint: EntryPoint2 };
    }
  });

  // partials/collapse_button.css
  var require_collapse_button = __commonJS({
    "partials/collapse_button.css"(exports, module) {
      module.exports = {};
    }
  });

  // partials/collapse_button.html
  var require_collapse_button2 = __commonJS({
    "partials/collapse_button.html"(exports, module) {
      module.exports = '<button class="collapse-btn">{{icon}}</button>';
    }
  });

  // partials/CollapseButton.js
  var require_CollapseButton = __commonJS({
    "partials/CollapseButton.js"(exports, module) {
      init_define_process_env();
      var { Partial } = require_slitan();
      require_collapse_button();
      var CollapseButton = class extends Partial {
        static template = require_collapse_button2();
        constructor(...args) {
          super(...args);
        ...
        get icon() {
          return this._collapsed ? "\u{1F642}" : "\u{1F643}";
        }
      };
  ...
  var require_HomePage = __commonJS({
    "HomePage.js"(exports, module) {
      init_define_process_env();
      var { Page } = require_slitan();
      var CollapseButton = require_CollapseButton();
      require_home_page();
      var HomePage = class extends Page {
  ...
  // index.js
  init_define_process_env();
  var { EntryPoint } = require_slitan();
  var Index = class extends EntryPoint {
    constructor() {
      super();
    }
    async init() {
      this.add_page(require_HomePage(), "#content");
    }
    async load() {
